...
-- 3) 테이블에 별명 지정
SELECT EMP.NAME     --> EMP. 생략가능 NAME만 써도 됨
...
SELECT EMP_NO, NAME, DEPART, POSITION, GENDER, HIRE_DATE, SALARY
  FROM EMPLOYEE
 WHERE EMP_NO LIKE '1%';        
   --> EMP_NO는 타입이 NUMBER이기 때문에 강제로 캐스팅된거라 실행은 가능하지만 옳은건 아님
