...
public class Ex04_switch {
	...
	public static void main(String[] args) {
		...
		// switch문
		// 표현식의 결과 값에 따른 분기를 처리한다.(조건 쓰지 X)
		// 표현식의 결과 값은 double, boolean 데이터타입일 수 없다.
		// 형식 (break는 끝남을 표현, 없으면 끝내지 못하고 실행문 계속 수행함)
		// switch(표현식) {
		// case 값: 실행문; break; 
		// case 값: 실행문; break;
		// default: 실행문;
		...
		// 내가 쓴 답
		// switch(floor) {
		// case 1: System.out.println("전지현"); break;
		// case 2: System.out.println("전지현"); break;
		// case 3: System.out.println("한지민"); break;
		// case 4: System.out.println("한지민"); break;
		// case 5: System.out.println("박은빈"); break;
		// case 6: System.out.println("박은빈"); break;
		// default: System.out.println("박보검");
		// }
