...
public class Main {
	...
	public static void m2() {
		...
		}catch(NumberFormatException e) {		//NumberFormatException, RuntimeExceptio가능  Exception 가능하지만 catch여러번일때는 순서 주의
	...
	public static void m3() { 
		...
		// a는 상관없이 b가 0일때 ArithmeticException발생
		// a에 소수나 문자가 들어가면 InputMismatchException발생
		try {
			...
			System.out.println("ArithmeticExceptin 발생");
