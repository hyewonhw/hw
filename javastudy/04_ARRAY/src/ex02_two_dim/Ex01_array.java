...
public class Ex01_array {
	...
	public static void main(String[] args) {
		...
		//    int[][] arr;
		// 2 .2차원배열의 생성
		//    1) arr = new int[3][2];    -> 3행 2열의 구조 (김밥3줄, 각 2개씩 조각냄)
		//	  2) arr = new int[3][]; 	 -> 3행 n열의 구조 (김밥3줄, 모두 다르게 조각)		
		//       arr[0] = new int[5]     -> 1번째 1차원배열 (1번째 김밥은 5개 조각)
		// 		 arr[1] = new int[3]     -> 2번째 1차원배열 (2번째 김밥은 3개 조각)
		// 		 arr[2] = new int[8]     -> 3번째 1차원배열 (3번째 김밥은 8개 조각)
