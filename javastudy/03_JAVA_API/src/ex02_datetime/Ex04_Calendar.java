...
public class Ex04_Calendar {
	...
	public static void main(String[] args) {
		...
		// 년, 월, 일, 요일
		// ctrl + 위 Calendar 누르면 Calendar.class 소스코드 볼수 있음 ex. YEAR(1), MONTH(2) ...
		int year = cal.get(Calendar.YEAR); // YEAR 상수값을 가져오라는 표기 // int year = cal.get(1); 
		...
		// System.out.println(weekNo);   // if 나 switch 활용
